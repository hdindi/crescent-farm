...
$(function() {
   $('#upload_profile').submit(function(e) {
      e.preventDefault();
      $.ajaxFileUpload({
         url         :'<?php echo base_url()?>administrator/admin/update_profile/', 
         secureuri      :false,
         ...
         data        : {
            ...
            'kinlname'              : $('#kinlname').val(),
            'kinrelation'           : $('#kinrelation').val(),
             'kinphone'             : $('#kinphone').val(),
            'employment_categroy'   : $('#employment_category').val(),
            'employment_class'      : $('#employment_class').val(),
            'dept'           : $('#dept').val()
         },
...
{
   $.get('<?php echo base_url()?>upload/files/')
   .success(function (data){
      $('#files').html(data);
   });
},5000
...
<?php echo form_close(); ?>
			...
			<div class="row-fluid sortable">
                        ...
                        <div class="types" id="types" style="display: none !important;"> Do you want ot register a new Land or an Existing land? <ul><li><?php echo anchor('farming/landregistration',' Register a New Land!'); ?></li><li><?php echo anchor('/newfarmingactivity',' Use an Existing Registered Land!'); ?></li></ul></div>
