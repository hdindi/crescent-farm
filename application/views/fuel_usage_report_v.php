                    ...
                    <tbody>
                        <?php foreach ($fuel_usage as $fuel_usage_details): ?>
                            <tr class="odd gradeX">
                                ...
                                <td class="center" ><?php echo $fuel_usage_details['actual_fuel_used']; ?></td>

                                <?php if ($fuel_usage_details['fuel_variance'] == "0") {
                                    ?>
                                <td class="center"><span class="label " ><?php echo $fuel_usage_details['fuel_variance']; ?></span></td>
                                    <?php
                                } elseif ($fuel_usage_details['fuel_variance'] > "0") {
                                    ?>
                                    <td class="center"><span class="label label-success"><?php echo $fuel_usage_details['fuel_variance']; ?></span></td>
                                    <?php
                                } elseif ($fuel_usage_details['fuel_variance'] < "0") {
                                    ?>
                                    <td class="center"><span class="label label-important"><?php echo $fuel_usage_details['fuel_variance']; ?></span></td>
                                    <?php }
                                ?>
