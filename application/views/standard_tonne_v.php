...
<table cellpadding="0"  style="width:100% !important;" cellspacing="0" border="0" class="table table-striped table-bordered bootstrap-datatable datatable" id="table_employee">
	...
	<tbody>
		 <?php foreach($standard_tonnes as $standard_tonnes_details ):?>
		<tr class="odd gradeX">
			<td class="center"><?php echo $standard_tonnes_details['standard_tonne_amount'];?></td>
                        
			<td class="center" ><?php echo $standard_tonnes_details['date_added'];?></td>
			
                        <td class="center" ><?php echo $standard_tonnes_details['user_name'];?></td>
            ...
            <td class="center">
									...
									<a class=" standard_tonne_edit btn btn-info" href="#edit_details">
										<i class="icon-edit icon-white"></i>  
										Edit                                            
									</a>
									
                
                            <input type="hidden" name="standard_tonne_id" value="<?php echo $standard_tonnes_details['standard_tonne_id'];?>" />
                            <input type="hidden" name="standard_tonne_amount" value="<?php echo $standard_tonnes_details['standard_tonne_amount']; ?>"/>
								</td>
...
<div id="edit_details" style="display:none !important;">
    ...
    <form class="update_standard_tonne_form" id="update_standard_tonne_form" method="post" >
    ...
    <ul class="form-section">
      ...
      <li id="cid_30" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_30" class="form-header">
            Standard Tonne Information
          </h2>
        </div>
      </li>
      <input type="hidden"  name="edit_standard_tonne_id" id="edit_standard_tonne_id" />
      ...
      <li class="form-line form-line-column" id="id_6">
        ...
        <div id="cid_6" class="form-input-wide">
            <input type="text" class=" form-textbox edit_standard_tonne_amount validate[required]" id="edit_standard_tonne_amount" name="edit_standard_tonne_amount" size="30"  />
        </div>
      </li>
      ...
      <li class="form-line" id="id_27">
        <div id="cid_27" class="form-input-wide">
          <div style="text-align:left" class="form-buttons-wrapper">
              <input type="submit" id="update_standard_tonne_button" class="update_standard_tonne_button" value="Update Standard Tonne Details" />	
          </div>
        </div>
      </li>
