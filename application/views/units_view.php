...
?>
<?php
$unit_id = $this->session->userdata('id');
...
$unit_category = $this->session->userdata('employment_category');
...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <div id="unit_table">  
                <div> <a class="add_unit btn btn-success" id="add_unit" href="#add_unit_window">
                        <i class="icon-plus-sign icon-white"></i>  
                        Add Unit                                         
                    </a> </div>
                <div> <a class="export_units_report btn btn-success" id="export_units_report" href="<?php echo base_url(); ?>admin_profile/export_units_report">
                        <i class="icon-plus-sign icon-white"></i>  
                        Export as Excel                                         
                    </a> </div>
                <table cellpadding="0"  style="width:auto !important;" cellspacing="0" border="0" class="table table-striped table-bordered bootstrap-datatable datatable" id="table_unit">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($units as $units_details): ?>
                            <tr class="odd gradeX">

                                <td class="center" ><?php echo $units_details['unit_name']; ?></td>

                                <td class="center" ><?php echo $units_details['unit_code']; ?></td>

                                <td class="center" ><?php echo $units_details['registration_number']; ?></td>



                                <?php if ($units_details['is_active'] === 'Active') {
                                    ?>
                                    <td class="center"><span class="label label-success"><?php echo $units_details['is_active']; ?></span></td>
                                    <?php
                                } elseif ($units_details['is_active'] === 'In Active') {
                                    ?>
                                    <td class="center"><span class="label label-important"><?php echo $units_details['is_active']; ?></span></td>
                                ...
                                <td class="center" ><?php echo $units_details['date_added']; ?></td>




                                <td class="center">
                                    <a class=" view_unit btn btn-success" href="#view_details">
                                        <i class="icon-zoom-in icon-white"></i>  
                                        View                                            
                                    </a>
                                    <a class=" edit_unit btn btn-info" href="#edit_details">
                                        <i class="icon-edit icon-white"></i>  
                                        Edit                                            
                                    </a>
                                    <a class=" delete_unit btn btn-danger" href="#delete_details">
                                        <i class="icon-trash icon-white"></i> 
                                        Delete
                                    </a>

                                    <input type="hidden" id="unit_id" name="unit_id" value="<?php echo $units_details['unit_id']; ?>" />
